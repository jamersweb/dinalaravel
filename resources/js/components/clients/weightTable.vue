    ...
    <div>
        <Vue3EasyDataTable
            ...
            <template #item-weight="item">
                <p v-if="item.current_weight!='-'" class="m-0 text-uppercase">{{item.current_weight}}</p>
                <p v-else class="m-0">{{item.current_weight}}</p>
            </template>
        </Vue3EasyDataTable>
    ...
    data() {
        return {
            ...
            headers: [
                ...
                { text: "Current Weight", value: "weight", sortable: true },
                { text: "Current BF%", value: "current_body_fat", sortable: true },
            ],
            items: [],
            itemsSelected: [],
        }
