<template lang="">
    <div class="my-popup-component">
        ...
        <div class="main-box w-80 p-2 p-md-4 position-relative" style="overflow-y:auto">
            ...
            <h4 class="m-0 text-center fw-bold">Create Exercise</h4>
            <div class="w-100 container-fluid">
                <div class="row justify-content-center">
                    ...
                    <div class="col-12 col-md-6 px-2">
                        <div class="">
                            <p class="fw-bold mt-2 mb-1">Exercise code <span class="text-muted small fw-normal">(optional, unique e.g. EX-001)</span></p>
                            <input @input="this.error = null" class="form-control" type="text" v-model="postData.content_code" placeholder="letters, numbers, dot, underscore, hyphen" maxlength="64" autocomplete="off">
                        </div>
                        <div class="mt-3">
                        ...
                        <div class="mt-3">
                            <div class="text-center">
                                <button @click="checkForErrors()" class="prim_btn_rnd_lg prim_btn w-100">Save</button>
                            </div>
                        </div>
                    </div>
                </div>
...
import viewExer from '../../components/master-libraries/viewExercise.vue';
import assignAlternateExercise from './assignAlternateExercise.vue';
export default {
    components: { listTags, Loader, Inform, Confirm, viewExer, assignAlternateExercise },
    data() {
        return {
            apiConfig: {
                headers: {
    ...
    methods: {
        ...
        showConfirmModal() {
            this.modalDetail = 'All of your progress will be lost'
        ...
        quitComponent() {
            this.$parent.toggleExerciseComponent();
        },
        changeMediaType() {
            this.media.selected = false;
            this.media.url = '';
        ...
        checkForErrors() {
            ...
            if (this.postData.video_type==='youtube' && this.postData.video==null ) {
                this.error = 'please enter youtube video URL';
                return;
            }
            if (this.postData.video_type==='custom' && this.postData.video==null ) {
        ...
        async createExercise() {
            ...
            if(this.postData.video_type==='image')
            fd.append('thumbnail', this.postData.image);
            else if(this.postData.video_type==='custom'){
            ...
            axios.post(config.baseApiUrl + 'create-exercise', fd, this.apiConfig).then(res => {
                this.pageLoading = false;
                if (res.data.status) {
                    this.modalTitle = 'Done!';
                    this.modalDetail = "Exercise created successfully";
                    ...
                    this.informModal = true;
                    console.log("Error: creating exercise ", res.data.message);
                }
            }).catch(er => {
                this.pageLoading = false;
                ...
                this.informModal = true;
                console.log("Error: creating exercise ", er);
            });
        },
