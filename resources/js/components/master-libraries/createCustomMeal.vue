<template lang="">
    <div class="my-popup-component">
        ...
        <div class="main">
            <h4 class="mt-3">Create Custom Meal</h4>
            ...
            <div style="width:95%;height:440px;margin-left:auto;margin-right:auto;">
                ...
                <div class="div2 position-relative" style="overflow-x:hidden;" v-if="addCover">
                    ...
                    <div v-else class="position-relative" style="width:80%;height:300px;border:1px solid #C5C5C5;margin-left:auto;margin-right:auto;margin-top:30px;border-radius:10px;text-align:center;padding-right:30px;;padding-left:30px;">
                        <div style="width:100%;height:100%;">
                            <img v-if="imageURL!=null" :src="imageURL" alt="" style="width:100%;height:95%;margin-top:10px;border-radius:10px; object-fit: contain; background: white;">
                            <video v-if="videoURL!=null" :src="videoURL" controls style="height:95%;margin-top:10px;border-radius:10px;" ></video>
                        </div>
                    </div>
                    ...
                    <div style="text-align:center;width:100%;height:30px;margin-top:15px">
                        <button class="btn1" @click="showRecipe1">Save</button>
                    </div>
                </div>
                <div class="div2 d-flex" v-if="addRecipe">
                    <div class="col-7" style="height:100%;overflow-y:auto;">
                        <div class="col-12 float-start" style="height:90%;" v-if="recipe1">
                        ...
                        <div class="col-12 float-start" style="height:400px;" v-if="recipe2">
                            <div class="col-12 pe-2 float-start">
                                <p style="font-size:13px;float:left;margin-left:10px;">Ingredients <span style="color:red;">*</span></p>
                            ...
                            <div style="width:95%;height:25px;float:left;margin-top:10px;">
                                <p style="font-size:13px;float:left;margin-left:10px;">Recipe Makes <span style="color:red;">*</span></p>
                                <input type="number" v-model="mealData.no_of_servings" min="1" class="inp4" placeholder="e.g 1">
                    ...
                    <div class="col-5 p-2 h-100 tm-brdr brds-2 text-center">
...
export default {
    ...
    methods: {
        ...
        getAllFoods() {
            axios
                .get(config.baseApiUrl + "get-foods", this.apiConfig)
                .then((res) => {
                    if (res.data.status) {
                        this.allFoods = res.data.data;
                        this.filterMealsByLanguage();
        ...
        saveForm() {
            ...
            this.pageLoading = true;
            axios.post(config.baseApiUrl + "create-new-meal", fd, this.apiConfig).then((res) => {
                this.pageLoading = false;
                if (res.data.status) {
                    this.modalTitle = "Done!";
                    this.modalDetail = "Meal saved";
                    this.informModal = true;
