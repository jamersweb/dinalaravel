<template lang="">
    <div class="my-popup-component" @click.self="showConfirmModal">
        ...
        <div class="main-box position-relative">
            ...
            <h4 class="my-2 text-center">Create Custom Food</h4>
                        ...
                        <div class="mx-0">
                            ...
                            <div class="px-3 mt-2">
                                ...
                                <div class="w-100 px-2 py-1 tm-brdr brds-1 d-flex flex-wrap" style="max-height:150px;overflow-y:auto">
                                    <span class="tg-pill" v-for="tgn in tagNames">{{tgn}}</span>
            ...
            <button type="button" class="prim_bg savebtn" @click="saveFood">Save</button>
        </div>
    </div>
</template>
<script>
...
export default {
    ...
    methods: {
        ...
        quitComponent() {
            this.$parent.addFoodPopup();
        },
        saveFood() {
            console.log("submitting: ",this.AddFoodData);
            ...
            if(this.AddFoodData.image===null){
                this.imgError = true;
                return;
            }
            let fd = new FormData();
            ...
            axios.post(config.baseApiUrl + 'create-new-food',fd, this.apiConfig).then(res => {
                ...
                if (res.data.status) {
                    ...
                    this.informModal = true;
                    console.log("Error: adding food ", res.data.error);
                }
            }).catch(er => {
                this.pageLoading = false;
